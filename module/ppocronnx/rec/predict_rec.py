...
from module.ppocronnx.utility import get_model_data, get_character_dict, get_model_data_from_path
from .rec_decoder import CTCLabelDecode

logger = logging
character_dict = get_character_dict()
rec_model_file = 'chinese_cht_PP-OCRv3_rec_infer.onnx'
...
class TextRecognizer(object):
    def __init__(self, rec_model_path=None, ort_providers=None):
        ...
        self.character_type = 'chinese_cht'
