...
#     text1 = pytesseract.image_to_string(screen,config=confignow)
#     text = text_error_handle(text1)
#     print(text)
#     #sleep 1 sec
#     time.sleep(1)
if 1:
    ...
    for device in devices:
        ...
        x,y = BASE.exists(device,FM_MAIL,0.75)
        while x or y:
            ...
            if x1 or y1:
                ...
                BASE.click_point(device,x,y)
            x,y = BASE.exists(device,FM_MAIL,th_hold = 0.75)
