...
class AreaBossAssets: 
	...
	# 极地鬼 十层 
	I_AB_JI_FLOOR_TEN = RuleImage(roi_front=(390,376,60,34), roi_back=(390,150,60,290), threshold=0.8, method="Template matching", file="./tasks/AreaBoss/res/ab_ji_floor_ten.png")
	# 小组内未取得名次 
