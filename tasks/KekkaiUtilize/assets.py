...
class KekkaiUtilizeAssets: 
	...
	# Image Rule Assets
	# 育成 
	I_SHI_GROWN = RuleImage(roi_front=(596.3333333333333,291.3333333333333,35,38), roi_back=(526.6666666666666,251.33333333333331,181,198), threshold=0.8, method="Template matching", file="./tasks/KekkaiUtilize/realm/realm_shi_grown.png")
	# 结界卡 
	I_SHI_CARD = RuleImage(roi_front=(885.3333333333333,291.66666666666663,43,56), roi_back=(801.3333333333333,241.33333333333331,215,175), threshold=0.8, method="Template matching", file="./tasks/KekkaiUtilize/realm/realm_shi_card.png")
	# description 
	...
	# 收取盒子的经验（没有满） 
	I_BOX_EXP = RuleImage(roi_front=(842,384,42,45), roi_back=(784,343,147,127), threshold=0.7, method="Template matching", file="./tasks/KekkaiUtilize/realm/realm_box_exp.png")
	# 结界皮肤 
