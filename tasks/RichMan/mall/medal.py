...
class Medal(FriendshipPoints):
    ...
    def execute_medal(self, con: MedalRoom = None):
        ...
        if con.challenge_pass:
            logger.hr('Buy challenge pass', 3)
