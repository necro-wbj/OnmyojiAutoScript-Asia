...
class GameUiAssets: 
	...
	# 器灵 
	I_EXPLORATION_GOTO_BONDLING_FAIRYLAND = RuleImage(roi_front=(1040,642,56,49), roi_back=(928,633,203,64), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_bondling_fairyland.png")
	# description 
	...
	# Image Rule Assets
	# description 
	I_MAIN_GOTO_TOWN = RuleImage(roi_front=(706,249,61,57), roi_back=(200,120,951,298), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_town.png")
	# description 
