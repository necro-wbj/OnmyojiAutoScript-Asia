...
class DemonEncounterAssets: 
	...
	# 点击首领 
	I_DE_BOSS = RuleImage(roi_front=(1001,645,45,45), roi_back=(1001,645,45,45), threshold=0.7, method="Template matching", file="./tasks/DemonEncounter/demon/demon_de_boss.png")
	# 点击封魔极 
