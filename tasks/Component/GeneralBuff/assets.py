...
class GeneralBuffAssets: 
	...
	# Ocr Rule Assets
	# Ocr-description 
	O_GOLD_50 = RuleOcr(roi=(428,120,338,389), area=(0,0,100,100), mode="Full", method="Default", keyword="戴国腾利得的金增加50%", name="gold_50")#战斗胜利获得的金币增加50%
	# Ocr-description 
	O_GOLD_100 = RuleOcr(roi=(425,118,342,397), area=(0,0,100,100), mode="Full", method="Default", keyword="戴国腾利得的金增加100%", name="gold_100")#战斗胜利获得的金币增加100%
	# Ocr-description 
	O_EXP_50 = RuleOcr(roi=(426,119,335,394), area=(0,0,100,100), mode="Full", method="Default", keyword="戴门腾利得的經验增加100%", name="exp_50")#战斗胜利获得的经验增加50%
	# Ocr-description 
	O_EXP_100 = RuleOcr(roi=(421,127,342,388), area=(0,0,100,100), mode="Full", method="Default", keyword="戴国滕利得的经验增加50%", name="exp_100")#战斗胜利获得的经验增加100%
	# 打开buff加成 
