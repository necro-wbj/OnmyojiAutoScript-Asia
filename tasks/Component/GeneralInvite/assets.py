...
class GeneralInviteAssets: 
	...
	# 点击邀请 
	I_INVITE_ENSURE = RuleImage(roi_front=(710,544,132,60), roi_back=(503,544,350,60), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_invite_ensure.png")
	# 判断是否点中好友了 
	I_SELECTED = RuleImage(roi_front=(895,373,33,32), roi_back=(347,163,500,300), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_selected.png")
	# 用来判断当前的列表是哪儿的 
