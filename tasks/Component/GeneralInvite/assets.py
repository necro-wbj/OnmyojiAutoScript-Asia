...
class GeneralInviteAssets: 
	...
	# Image Rule Assets
	# description 
	I_GI_EMOJI_1 = RuleImage(roi_front=(29,538,49,54), roi_back=(17,527,74,75), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_gi_emoji_1.png")
	# description 
