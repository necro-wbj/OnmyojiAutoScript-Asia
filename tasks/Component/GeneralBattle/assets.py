...
class GeneralBattleAssets: 
	...
	# 针对封魔的特殊 
	I_DE_WIN = RuleImage(roi_front=(518,67,65,59), roi_back=(518,67,65,59), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_de_win.png")
	# description 
