...
class WeeklyTriflesAssets: 
	...
	# 微信 
	I_WT_SE_WECHAT = RuleImage(roi_front=(904,625,46,48), roi_back=(777,607,441,84), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/secret/secret_wt_se_wechat.png")
	# 勾玉 
	...
	# 微信分享 
	I_WT_COLLECT_WECHAT = RuleImage(roi_front=(904,625,46,48), roi_back=(777,607,441,84), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/collect/collect_wt_collect_wechat.png")
	# 二维码 
	...
	# 微信分享 
	I_WT_AB_WECHAT = RuleImage(roi_front=(980,642,50,41), roi_back=(815,623,454,83), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/area_boss/area_boss_wt_ab_wechat.png")
