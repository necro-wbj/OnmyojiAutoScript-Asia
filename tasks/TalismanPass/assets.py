...
class TalismanPassAssets: 
	...
	# 任务 的右上方红点 
	I_RED_POINT_TASK = RuleImage(roi_front=(1229,297,23,24), roi_back=(1217,284,46,52), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_red_point_task.png")
	# 今日 的右上方红点 
	I_RED_POINT_DAY = RuleImage(roi_front=(639,157,23,26), roi_back=(622,145,47,58), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_red_point_day.png")
	# 本周 的右上方红点 
	I_RED_POINT_WEEK = RuleImage(roi_front=(800,153,24,25), roi_back=(786,147,48,40), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_red_point_week.png")
	# 等级奖励 
	I_RED_POINT_LEVEL = RuleImage(roi_front=(1226,165,21,22), roi_back=(1214,154,41,54), threshold=0.8, method="Template matching", file="./tasks/TalismanPass/tp/tp_red_point_level.png")
	# 选择一号奖励 
	I_TP_LEVEL_1 = RuleImage(roi_front=(203,435,122,59), roi_back=(203,435,122,59), threshold=0.6, method="Template matching", file="./tasks/TalismanPass/tp/tp_tp_level_1.png")
	# 选择二号奖励 
	I_TP_LEVEL_2 = RuleImage(roi_front=(577,435,122,55), roi_back=(577,435,122,55), threshold=0.6, method="Template matching", file="./tasks/TalismanPass/tp/tp_tp_level_2.png")
	# 选择三号奖励 
	I_TP_LEVEL_3 = RuleImage(roi_front=(967,433,109,61), roi_back=(967,433,109,61), threshold=0.6, method="Template matching", file="./tasks/TalismanPass/tp/tp_tp_level_3.png")
	# 前往 
