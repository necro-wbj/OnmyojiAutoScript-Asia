...
class SecretAssets: 
	...
	# Ocr Rule Assets
	# 未通關 
	O_SE_NO_PASS = RuleOcr(roi=(428,151,262,248), area=(428,151,262,248), mode="Full", method="Default", keyword="未通關", name="se_no_pass")
	# 第一个位置的层数 
	...
	# 后面的时候识别为通关的 
	O_SE_NO_PASS_LAST = RuleOcr(roi=(429,381,180,234), area=(429,381,180,234), mode="Full", method="Default", keyword="未通關", name="se_no_pass_last")
	# 勾玉 
