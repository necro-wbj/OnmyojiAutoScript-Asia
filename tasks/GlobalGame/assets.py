...
class GlobalGameAssets: 
	...
	# description 
	I_UI_BACK_RED = RuleImage(roi_front=(1041,111,34,38), roi_back=(877,15,383,254), threshold=0.7, method="Template matching", file="./tasks/GlobalGame/ui/ui_ui_back_red.png")
	# description 
