...
class PetsAssets: 
	...
	# 其乐融融 
	I_PET_HAPPY = RuleImage(roi_front=(955,625,70,70), roi_back=(955,625,70,70), threshold=0.8, method="Template matching", file="./tasks/Pets/pet/pet_pet_happy.png")
	# 大餐 
	I_PET_FEAST = RuleImage(roi_front=(845,625,70,70), roi_back=(845,625,70,70), threshold=0.8, method="Template matching", file="./tasks/Pets/pet/pet_pet_feast.png")
	# 玩耍 
