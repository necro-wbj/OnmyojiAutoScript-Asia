...
class OrochiAssets: 
	...
	# description 
	I_OROCHI_LOCK = RuleImage(roi_front=(563.3333333333333,565,22,26), roi_back=(548,546,109,62), threshold=0.8, method="Template matching", file="./tasks/Orochi/o/o_orochi_lock.png")
	# description 
