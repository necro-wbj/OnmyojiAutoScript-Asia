...
class FrogBossAssets: 
	...
	# frog_boss_enter 
	I_FROG_BOSS_ENTER = RuleImage(roi_front=(1181,153,59,54), roi_back=(1155,123,97,449), threshold=0.6, method="Template matching", file="./tasks/FrogBoss/fb/fb_frog_boss_enter.png")
